        ...
        <?php foreach ($chefs as $chef){ ?>
            <div class="chief-block">
                ...
                <div class="chief-descr">
                    ...
                    <a target="_blank" href="<?=$chef->href_en?>" class="chief-link">
                        <?=$chef->link_en?>
                    ...
                    <div id="block_<?= $category->id ?>" class="menu-block">
                        ...
                        <?php foreach ($category->products as $product) { ?>
                            <?php if ($product->status === 1) { ?>
                                ...
                                <?php if ($product->additional_en){ ?>
                                    <div class="tip-block">
                                        <?=$product->additional_en?>
                                    </div>
                                <?php } ?>

                                <?php if ($product->link_en) { ?>
                                    <a target="_blank" href="<?= $product->href_en ?>" class="link-block">
                                        <h4>
                                            <div class="ico-block">
